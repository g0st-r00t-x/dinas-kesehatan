...
class UsulanRevisiSkPangkatPolicy
{
    ...
    {
        return $user->can('force_delete_usulan::revisi::sk::pangkat');
    }
    ...
    {
        return $user->can('force_delete_any_usulan::revisi::sk::pangkat');
    }
    ...
    {
        return $user->can('restore_usulan::revisi::sk::pangkat');
    }
    ...
    {
        return $user->can('restore_any_usulan::revisi::sk::pangkat');
    }
